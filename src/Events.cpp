							...
							if (_stricmp(tag.c_str(), a_tag.c_str()) == 0)
							{
								for (const auto& playImpactEffect : footstep.playImpactEffects)
								{
									...
									(
										...
										"rayCast.origin.nodeName: \"{}\", rayCast.origin.offset.direction: ({}, {}, {}), rayCast.origin.offset.length: {}, "
										"rayCast.ray.direction: ({}, {}, {}), rayCast.ray.length: {}, "
										"rayCast.rotation: \"{}\" ({}, {}, {}), "
										"decal.rotation: \"{}\" ({}, {}, {}), "
										"decal.force: {}",
										...
										rayCast.origin.nodeName, rayCast.origin.offset.direction.x, rayCast.origin.offset.direction.y, rayCast.origin.offset.direction.z, rayCast.origin.offset.length,
										rayCast.ray.direction.x, rayCast.ray.direction.y, rayCast.ray.direction.z, rayCast.ray.length,
